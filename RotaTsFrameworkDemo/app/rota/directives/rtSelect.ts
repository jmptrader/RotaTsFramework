...
import {ISelectModel, ISelection, ISelectedEventArgs, ISelectedIndexChangedEvent, IItemsDataSourceMethod,
    IItemsDataSource, IDataSource, ISelectScope, ISelectConstants, ISelectAttributes} from './rtSelect.interface';
//deps
